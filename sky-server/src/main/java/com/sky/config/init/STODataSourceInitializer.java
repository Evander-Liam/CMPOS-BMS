...
import com.sky.utils.SpringUtil;
...
@Slf4j
@Configuration
public class STODataSourceInitializer {
    ...
    private boolean autoInitDatabase() {
        ...
        // 注意URL类只支持标准的URL"mysql://"，不支持"jdbc:mysql://"
        URI url = URI.create(SpringUtil.getConfig("spring.datasource.druid.url").substring(5));
        String uname = SpringUtil.getConfig("spring.datasource.druid.username");
        String pwd = SpringUtil.getConfig("spring.datasource.druid.password");
